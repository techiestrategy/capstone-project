...
const InventoryScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <HeaderWithBackCard title="Send Bulk SMS" spaceTop={30} />
        ...
        >
          <View style={styles.formContainer}>
            <InventoryForm
              ...
              locationProps={{
                label: 'Message Body', // Label for the new field
                placeholder: 'e.g., This is a reminder.',
              ...
              secondaryDescriptionProps={{
                label: 'Enter recipients number',
                placeholder: 'e.g., 234801234567, 2348910928990',
                 multiline: true,
